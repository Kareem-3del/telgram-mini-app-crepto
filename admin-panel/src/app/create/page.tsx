...
import { createATask } from "../../api/task";
...
const Create = () => {
    ...
    const createAd = async () => {
      ...
      try {
        ...
        const createRes = await createATask(adDetails);
  ...
  return (
    <main className="w-full min-h-screen flex flex-col justify-start items-center py-[30px] relative px-[20px]">
      <Navbar />
      <h1 className="text-[25px] mb-[20px]">Create an Ad</h1>
      <div className="w-full max-w-[350px] mt-[25px] flex flex-col justify-start items-center">
        ...
        <select
          ...
          name="category"
          id="category"
          className="mt-[5px] mb-[20px] bg-[#000000]"
          value={category}
        >
